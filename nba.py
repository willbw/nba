...
print()
print('Enter a game number to see the box score')
...
while True:
  print()
  print('Enter a game number to see the box score or "s" to see the scores again')
  action = input(' > ')
  try:
    if action == 's':
      print_scores(games)
    ...
    if action - 1 >= len(games): 
      print('Invalid selection.')
    else:
      print('Unable to get boxscore.')
>>>>>>> dev
